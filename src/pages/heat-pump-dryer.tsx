...
const technicalFeatures = [
    "Controlled temperature and humidity regulation",
    ...
    "Industrial automation and monitoring integration"
]

const operationalBenefits = [
    "Lower energy consumption compared to conventional dryers",
    "Improved product quality through controlled drying",
    "Reduced operating costs",
    "Consistent and uniform moisture removal",
...
const industryApplications = [
    {
        ...
        applications: [
            ...
            "Controlled drying of agricultural produce"
        ],
        expanded: true
    },
    {
        ...
        applications: [
            ...
            "Support for controlled production environments"
        ],
        expanded: false
    },
    {
    ...
    },
    {
        ...
        applications: [
            "Polymer drying",
            "Dehumidification before molding processes"
        ],
        expanded: false
    },
    {
...
const HeatPumpDryer = () => {
    return (
        <>
            <PageTitle title="Heat Pump Dryer" currentPage="Services" />
                            ...
                            <div className="col-12 col-lg-8 order-1 order-lg-2">
                                <div className="service-details-items">
                                    <div className="details-image wow fadeInUp" data-wow-delay=".3s">
                                        {/* You can replace this src with an HPD specific image */}
                                        <img src="/img/service/Heat_pump_dryer.png" alt="Heat Pump Dryer" style={{ width: '100%', height: '400px', objectFit: 'cover', borderRadius: '10px' }} />
                                    </div>
                                    <div className="details-content mt-4">
                                        <h3 className="wow fadeInUp" data-wow-delay=".5s">Heat Pump Dryer</h3>
                                        <p className="mt-3 wow fadeInUp" data-wow-delay=".6s">
                                            ASPCV’s Heat Pump Dryers are energy-efficient drying systems designed for controlled, low- to medium-temperature industrial drying applications. By utilizing heat recovery and closed-loop air circulation, these systems significantly reduce energy consumption while maintaining precise temperature and humidity control. They provide a reliable and sustainable alternative to conventional fuel-based drying methods.
                                        </p>
                                        ...
                                        <div className="content mt-4 mb-5 wow fadeInUp" data-wow-delay=".6s">
                                            ...
                                            <p className="mt-2 text-muted">
                                                ASPCV provides structured lifecycle support to ensure long-term dryer performance and operational stability. Our services include:
                                            </p>
                                            ...
                                            <p className="mt-2 text-muted">
                                                Through proactive servicing and performance monitoring, we ensure consistent drying quality, minimized downtime, and extended equipment lifespan.
                                            </p>
                                        </div>

                                        <h3 className="wow fadeInUp" data-wow-delay=".3s">Industry Applications</h3>
                                        <p className="mt-3 wow fadeInUp" data-wow-delay=".4s">
                                            Our Heat Pump Dryers are highly versatile and cater to a wide range of industrial requirements. Explore the primary applications across different sectors below:
                                        </p>
