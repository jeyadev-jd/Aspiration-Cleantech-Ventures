...
const technicalFeatures = [
    "Solar thermal-based drying chambers",
    "Controlled airflow and temperature regulation",
...
const operationalBenefits = [
    ...
    "Environmentally sustainable drying process",
...
const industryApplications = [
    {
        ...
        applications: [
            ...
            "Pre-drying for further industrial processing"
        ],
        expanded: true
    },
    {
        industry: "Textile",
        applications: [
            "Fabric pre-drying and moisture reduction",
            "Sustainable drying support for finishing processes"
        ],
        expanded: false
    },
    {
        ...
        applications: [
            "Pre-drying of timber and wood components",
            "Moisture conditioning prior to kiln processing"
        ],
        expanded: false
    },
    {
        ...
        applications: [
            "Drying of grains, seeds, and biomass",
...
const lifecycleSupportServices = [
    "Scheduled inspections and system cleaning",
    "Airflow and temperature calibration",
    "Structural and collector performance checks",
...
const SolarDryer = () => {
    return (
        <>
            <PageTitle title="Solar Dryer" currentPage="Services" />
                            ...
                            <div className="col-12 col-lg-8 order-1 order-lg-2">
                                <div className="service-details-items">
                                    <div className="details-image wow fadeInUp" data-wow-delay=".3s">
                                        {/* You can replace this src with a Solar Dryer specific image */}
                                        <img src="/img/service/solar-dryer.png" alt="Solar Dryer" style={{ width: '100%', height: '400px', objectFit: 'cover', borderRadius: '10px' }} />
                                    </div>
                                    <div className="details-content mt-4">
                                        <h3 className="wow fadeInUp" data-wow-delay=".5s">Solar Dryer</h3>
                                        <p className="mt-3 wow fadeInUp" data-wow-delay=".6s">
                                            ASPCV’s Solar Dryers are designed to provide sustainable and energy-efficient drying solutions for industrial and agricultural applications. Utilizing solar thermal energy, these systems enable controlled drying processes while reducing dependence on conventional fuel-based heating methods. The technology ensures uniform moisture removal, improved product quality, and lower operating costs.
                                        </p>
                                        ...
                                        <div className="content mt-4 mb-5 wow fadeInUp" data-wow-delay=".6s">
                                            ...
                                            <p className="mt-2 text-muted">
                                                ASPCV provides structured maintenance and performance monitoring services to ensure long-term operational stability of Solar Dryer systems. Our lifecycle support includes:
                                            </p>
                                            ...
                                            <p className="mt-2 text-muted">
                                                Through continuous monitoring and proactive servicing, we ensure consistent drying performance, system durability, and sustained operational efficiency.
                                            </p>
                                        </div>

                                        <h3 className="wow fadeInUp" data-wow-delay=".3s">Industry Applications</h3>
                                        <p className="mt-3 wow fadeInUp" data-wow-delay=".4s">
                                            Our Solar Dryers are highly versatile and cater to a wide range of industrial requirements. Explore the primary applications across different sectors below:
                                        </p>
