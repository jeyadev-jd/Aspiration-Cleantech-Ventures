                            ...
                            <div className="col-12 col-lg-8 order-1 order-lg-2">
                                <div className="service-details-items">
                                    <div className="details-image mb-5 wow slideUp">
                                        <img src="/img/academy/sales-executive.webp" alt="Sales Executive Header" style={{ width: "100%", borderRadius: "20px", display: "block" }} />
                                    </div>
                                    <div className="details-content wow slideUp">
                                        <h2 style={{ fontSize: "2.6rem", fontWeight: "800", marginBottom: "15px", color: "#1a1a2e" }}>Sales Executive Training Program</h2>

                                        <p style={{ fontSize: "1.15rem", color: "#666", lineHeight: 1.8, marginBottom: "40px" }}>
                                            Develop professional selling skills, customer relationship management, and sales techniques for career success.
                                        </p>
                                        ...
                                        <div className="row mt-4 mb-5">
                                            <div className="col-md-12 mb-4 mb-md-0">
                                                <div className="p-4 h-100" style={{ background: "rgba(29, 143, 44, 0.05)", borderLeft: "4px solid var(--theme)", borderRadius: "10px" }}>
                                                    ...
                                                    <h3 style={{ fontSize: "1.5rem", margin: 0, fontWeight: 800 }}>6 Weeks</h3>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="text-center mt-5 pt-3 wow slideUp">
                                            ...
                                            <div>
                                                <Link to="/academy-register?course=sales" className="theme-btn py-3 px-5">Apply For Training &nbsp;<i className="fa-solid fa-arrow-right"></i></Link>
                                            </div>
                                        </div>
