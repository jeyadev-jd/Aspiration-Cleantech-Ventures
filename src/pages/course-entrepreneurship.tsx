                            ...
                            <div className="col-12 col-lg-8 order-1 order-lg-2">
                                <div className="service-details-items">
                                    <div className="details-image mb-5 wow slideUp">
                                        <img src="/img/academy/entrepreneur.jpg" alt="Entrepreneurship Header" style={{ width: "100%", borderRadius: "20px", display: "block" }} />
                                    </div>
                                    <div className="details-content wow slideUp">
                                        <h2 style={{ fontSize: "2.6rem", fontWeight: "800", marginBottom: "15px", color: "#1a1a2e" }}>Entrepreneurship Training Program</h2>

                                        <p style={{ fontSize: "1.15rem", color: "#666", lineHeight: 1.8, marginBottom: "40px" }}>
                                            Learn to build, launch, and scale your own business with practical entrepreneurship training and mentorship.
                                        </p>
                                        ...
                                        <div className="text-center mt-5 pt-3 wow slideUp">
                                            ...
                                            <div>
                                                <Link to="/academy-register?course=entrepreneurship" className="theme-btn py-3 px-5">Apply For Training &nbsp;<i className="fa-solid fa-arrow-right"></i></Link>
                                            </div>
                                        </div>
...
export default CourseEntrepreneurship
